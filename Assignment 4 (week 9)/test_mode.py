...
def load_and_encode_dataset(file_path, stoi):
...
# Create vocabulary mapping (same as in training)
...
for test_file in test_files:
    print("Evaluating ", test_file)
    
    # Load and encode test data
    test_data, test_text = load_and_encode_dataset(test_file, stoi)
    
    # Calculate loss
    test_loss = evaluate_loss(model, test_data)
    
    # Calculate baseline
    baseline_loss = -torch.log(torch.tensor(1.0 / vocab_size)).item()
    
    print("Test Loss: ",test_loss)
    print("Baseline Loss: ",baseline_loss)
    print("Improvement over baseline: ",baseline_loss - test_loss)
    print("")